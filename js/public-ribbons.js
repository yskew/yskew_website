...
var Ribbons = class {
  constructor(container, options = {}) {
    ...
    this.baseThickness = options.baseThickness || 40;
    this.offsetFactor = options.offsetFactor || 0.05;
    this.maxAge = options.maxAge !== void 0 ? options.maxAge : 500;
    this.pointCount = options.pointCount || 50;
    this.speedMultiplier = options.speedMultiplier !== void 0 ? options.speedMultiplier : 0.55;
    this.enableFade = options.enableFade !== void 0 ? options.enableFade : false;
    this.enableShaderEffect = options.enableShaderEffect !== void 0 ? options.enableShaderEffect : true;
    ...
    this.colors.forEach((color, index) => {
      ...
      line.polyline = new Polyline(gl, {
        ...
        uniforms: {
          ...
          uOpacity: { value: 1 },
          uTime: { value: 0 },
          uEnableShaderEffect: { value: this.enableShaderEffect ? 1 : 0 },
          uEffectAmplitude: { value: this.effectAmplitude },
          uEnableFade: { value: this.enableFade ? 1 : 0 }
        }
      });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  ribbonsContainer.style.pointerEvents = "none";
  ribbonsContainer.style.zIndex = "5";
  document.body.insertBefore(ribbonsContainer, document.body.firstChild);
  new Ribbons(ribbonsContainer, {
    colors: ["#cccccc"],
    // White/grey color as requested
    baseThickness: 40,
